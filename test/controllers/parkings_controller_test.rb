...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { address_number: @parking.address_number, city: @parking.city, street: @parking.street } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { address_number: @parking.address_number, city: @parking.city, street: @parking.street } }
